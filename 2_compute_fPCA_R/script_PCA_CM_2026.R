...
output_dir <- file.path(project_dir, "processed", "2_fPCA", "CMA_masked")
dir.create(output_dir, recursive = TRUE, showWarnings = FALSE)

data=read.table(file.path(input_dir, "CMA_masked.txt"),header=TRUE, na.strings=c("NA", ""))
...
#   }
#   
# },video.name = "mld_ker.mp4", other.opts = "-pix_fmt yuv420p -b 300k")
