...
- GLORYS MLD is computed from potential-density anomaly using a threshold relative to 10 m:
  - Full GLORYS: `Delta sigma0 = 0.03 kg m-3`.
  - Co-located GLORYS (`GLORYS_CL`): `Delta sigma0 = 0.02 kg m-3`, matching the legacy notebook setup.
...
- GLORYS vs CMA: `0.668`.
- GLORYS_CL vs CMA: `0.840`.
- GLORYS vs GLORYS_CL: `0.741`.
...
| Summer | 0.17 (0.33) | 0.23 (0.36) | 0.23 (0.43) |
| Winter | 0.06 (0.85) | -0.89 (0.05) | -0.63 (0.37) |
